...
3. **Handoff doc.** Look in the OS temp directory (e.g. `C:\Users\<user>\AppData\Local\Temp\`) for a file matching this repo's name (e.g. `digital-mail-and-document-service-handoff.md`).
